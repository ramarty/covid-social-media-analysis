      ...
      dashboardBody(
        ...
        fluidRow(
          column(6, align = "left", offset = 3,
                 ...
                 <li><h4><b>Small z-scores</b> indicate that the chosen lead/lag day isn't that different from others, so the chosen lead/lag day is relatively arbitrary</h4></li>
                 </ul>
                      </ul>"),
