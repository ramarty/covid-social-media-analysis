...
frontline_df <- brazil_tweets[grepl("\\bdoctor\\b|médica|médico|medica|medico|enfermeira|enfermeiro|hospital", brazil_tweets$user_description),]
frontline_df <- frontline_df[!grepl("^rt", frontline_df$full_text),]
