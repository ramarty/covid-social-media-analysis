...
for(start_date_i in start_dates){
  ...
  # Export -----------------------------------------------------------------------
  saveRDS(results_df, file.path(dropbox_file_path, "Data", "google_trends", "RawData", "cross_state_bidaily", paste0("brazil_extract_crosstate_",search_dates,".Rds")))
  write.csv(results_df, file.path(dropbox_file_path, "Data", "google_trends", "RawData", "cross_state_bidaily", paste0("brazil_extract_crosstate_",search_dates,".csv")), row.names=F)
}
